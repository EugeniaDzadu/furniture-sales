		      ...
		      <div className="row mb-5">
		        <div className="col-md-12">
		          <div className="border p-4 rounded" role="alert">
		            Returning customer? <HashLink href="#">Click here</HashLink> to login
		          </div>
		        </div>
		      </div>
		      <div className="row">
		            ...
		            <div className="col-md-12">
		              ...
		              <div className="p-3 p-lg-5 border bg-white">
		                ...
		                <div className="border p-3 mb-3">
		                  <h3 className="h6 mb-0"><HashLink className="d-block" data-bs-toggle="collapse" href="#collapsebank" role="button" aria-expanded="false" aria-controls="collapsebank">Direct Bank Transfer</HashLink></h3>
		                ...
		                <div className="border p-3 mb-3">
		                  <h3 className="h6 mb-0"><HashLink className="d-block" data-bs-toggle="collapse" smoth to="#collapsecheque" role="button" aria-expanded="false" aria-controls="collapsecheque">Cheque Payment</HashLink></h3>
		                ...
		                <div className="border p-3 mb-5">
		                  <h3 className="h6 mb-0"><HashLink className="d-block" data-bs-toggle="collapse" smooth to="#collapsepaypal" role="button" aria-expanded="false" aria-controls="collapsepaypal">Paypal</HashLink></h3>
